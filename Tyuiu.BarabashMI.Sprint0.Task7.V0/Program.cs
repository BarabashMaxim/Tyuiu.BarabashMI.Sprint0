using Tyuiu.BarabashMI.Sprint0.Task7.V0.Lib;
class Program
{
    static void Main(string[] args)
    {
        Console.Title = "Спринт #0 | Выполнил Барабаш М. И. | ИИПб-25-1";
        Console.WriteLine("***************************************************************************");
        ...
        {
            Console.WriteLine("Ошибка! Исходные Массивы имеют разное количесвто элементов");
        }
        Console.ReadKey();
    }
}
